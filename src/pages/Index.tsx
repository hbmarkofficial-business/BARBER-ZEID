  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Augsburg | BARBER ZEID</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop BARBER ZEID in Augsburg für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="BARBER ZEID | Premium Barbershop Augsburg" />
        <meta
        ...
        <meta name="twitter:title" content="BARBER ZEID | Premium Barbershop Augsburg" />
        <meta
